...
if(!isset($_GET['academy']))
    header("location:academy_management.php");
$academyname=$_GET['academy'];
$get_academy=mysqli_query($connection,"select * from academy where academy_id='$academyname'");
$run_academy=mysqli_fetch_assoc($get_academy);
?>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="container-academy-management-detail">
        ...
        <div class="academy-management-detail-content-container">
            <div class="academy-management-detail-content-box">
                ...
                <form action="doform/doCpEditAcademy.php?academy=<?php echo $academyname; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="management-content-box-panel">
                            <div class="management-content-box-panel-split">
                                ...
                                <div class="management-content-box-panel-right" style="width:63%">
                                    <input type="date" name="date" value="<?php echo $run_academy['academy_time'];?>">
                                    <input type="text" name="aname" value="<?php echo $run_academy['academy_name'];?>" placeholder="Academy Name">
                                    <input type="time" name="timestart" value="<?php echo $run_academy['time_start'];?>">
                                    <span style="font-family:Proxima novasemi;font-size:20px;"> TO </span>
                                    <input type="time" name="timeend" value="<?php echo $run_academy['time_end'];?>">
                                    <input type="text" name="price" value="<?php echo $run_academy['academy_price'];?>">
                                    <span style="margin-left:-30px;font-family:Proxima novasemi;font-size:14px;">IDR</span>
                                    <input type="text" name="place" value="Jakarta" placeholder="Place">
                                    <input type="text" name="capacity" value="<?php echo $run_academy['academy_limit'];?>" placeholder="Academy Limit" maxlength="3">
                                    <span style="margin-left:-60px;font-family:Proxima novasemi;font-size:18px;">person</span>
                                    <input type="text" name="stock" value="<?php echo $run_academy['academy_stock'];?>" placeholder="Academy Stock" maxlength="3">
                                    <span style="margin-left:-60px;font-family:Proxima novasemi;font-size:18px;">person</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="management-content-box-panel">
                            <div class="management-content-box-panel-split">
                                ...
                                <div class="management-content-box-panel-right">
                                    <textarea name="detail"><?php echo $run_academy['academy_description']; ?></textarea>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="management-content-box-image-split">
                                        <div class="management-content-box-image-left">
                                            <div class="management-content-box-image-container" id="uploadForm">
                                                <img src="../img/academy-image/<?php echo $run_academy['academy_image'];?>" class="edite">
                                            </div> 
                                        </div>
