...
else
{
    ...
    $get_update = "insert into event values('','$product_image','$name','$detail','$fl','$content','$date')";
    $query = mysqli_query($connection,$get_update);
    
    header("location:../event_management_addnew.php?success= '$name' event has been successfully added.");
}
}
?>