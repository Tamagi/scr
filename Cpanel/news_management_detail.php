...
$newsname=$_GET['news'];
$get_news=mysqli_query($connection,"select * from news where id='$newsname'");
$run_news=mysqli_fetch_assoc($get_news);
?>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="container-news-management-detail">
        ...
        <div class="news-management-detail-content-container">
            <div class="news-management-detail-content-box">
                ...
                <form action="doform/doCpEditnews.php?news=<?php echo $newsname; ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="management-content-box-image-split">
                                        <div class="management-content-box-image-left">
                                            <div class="management-content-box-image-container" id="uploadForm">
                                                <img src="../img/news-image/<?php echo $run_news['news_image'];?>" class="edite">
                                            </div> 
                                        </div>
                        ...
                        <div class="management-content-box-panel">
                            <div class="management-content-box-panel-split">
                                ...
                                <div class="management-content-box-panel-right" style="width:70%">
                                    <input type="date" name="date" value="<?php echo $run_news['news_date'];?>">
                                    <input type="text" name="aname" value="<?php echo $run_news['news_title'];?>" palceholder="News Title">
                                    <textarea name="details" placeholder="Details (max 165 characters)"maxlength="165"><?php echo $run_news['news_detail'];?></textarea>
                                    <input type="text" name="fl" value="<?php echo $run_news['first_letter'];?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="management-content-box-bottom">
                        <textarea id="area" name="contents"><?php echo $run_news['news_content']; ?></textarea>
                    </div>
