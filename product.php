...
<body>
    <div class="container-product">
        ...
        <div class="content-product">
            <img src="http://localhost/simetri/img/default-image/Product-Hero-Image.png" class="hero-image">
                ...
                <div class="homepage-product-mid-container">
                    <div class="homepage-product-mid-container-content">
                        ...
                        <p class="homepage-product-title">
                            great coffee beans deserve your home
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="content-many-product">
            ...
            <div class="content-many-product-container" id="content">
                <img src="http://localhost/simetri/img/shop-image/<?php echo $product_baris['product_image']; ?>" id="imghover"class="imghover">
                <a href="http://localhost/simetri/product_detail/<?php echo $product_baris['product_id'];?>/<?php echo $product_baris['product_name']; ?>" style="text-decoration:none;">
                    ...
                    <div class="content-many-product-hover-content">
                        <p class="homepage-product-subtitle"><?php echo $product_baris['origin']; ?></p>
                        <p class="homepage-product-title"><?php echo $product_baris['product_name']; ?></p>
                        <div class="product-hover-button">
                            <a href="http://localhost/simetri/product_detail/<?php echo $product_baris['product_id'];?>/<?php echo $product_baris['product_name']; ?>">
                                <svg version="1.1"
                                     xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/"
            ...
            <div class="content-many-product-container" id="content">
                <img src="http://localhost/simetri/img/shop-image/<?php echo $product_baris['product_image']; ?>" id="imghover"class="imghover">
                <a href="#"onclick="mafun()" style="text-decoration:none;">
                    <div class="content-many-product-hover-container" id="hover">
                    <div class="content-many-product-hover-opacity">
